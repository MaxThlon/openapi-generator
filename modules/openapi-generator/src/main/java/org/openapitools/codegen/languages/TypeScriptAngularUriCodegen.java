...
public class TypeScriptAngularUriCodegen extends AbstractTypeScriptClientCodegen {
    private static final Logger LOGGER = LoggerFactory.getLogger(TypeScriptAngularUriCodegen.class);
    ...
    public TypeScriptAngularUriCodegen() {
        super();
        this.outputFolder = "generated-code/typescript-angular";

        embeddedTemplateDir = templateDir = "typescript-angular-uri";
    ...
    public void processOpts() {
        super.processOpts();
        supportingFiles
                .add(new SupportingFile("apis.mustache", getIndexDirectory() , apiPackage + ".ts"));
